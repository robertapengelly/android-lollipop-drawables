 ...
 *
 * <p>A touch feedback drawable may contain multiple child layers, including a
 ...
 * </pre></p>
 *
 * <p>If a mask layer is set, the ripple effect will be masked against that layer
 * before it is drawn over the composite of the remaining child layers.</p>
 *
 * <p>If no mask layer is set, the ripple effect is masked against the composite
 * of the child layers.
 * <pre>
 ...
 * </pre></p>
 *
 * <p>If no child layers or mask is specified and the ripple is set as a View
...
public class RippleDrawable extends LayerDrawable {
    ...
    /** The masking layer, e.g. the layer with id android.R.id.mask. */
    ...
    private void drawBackgroundAndRipples(Canvas canvas) {
        ...
        if (mMaskColorFilter != null) {
            ...
            mMaskColorFilter = DrawableReflectiveUtils.setColor(mMaskColorFilter, fullAlphaColor, PorterDuff.Mode.SRC_IN);
    ...
    private void updateMaskShaderIfNeeded() {
        ...
        if ((mMaskBuffer == null) || (mMaskBuffer.getWidth() != bounds.width())
