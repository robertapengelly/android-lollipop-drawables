...
class Interpolators {
     ...
     */
    static class INDETERMINATE_HORIZONTAL_RECT1_SCALE_X {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
     ...
     */
    static class INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
     ...
     */
    static class INDETERMINATE_HORIZONTAL_RECT2_SCALE_X {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
     ...
     */
    static class INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
    ...
    static class TRIM_PATH_END {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_TRIM_PATH_END);
    
    }
    
    /** Backported Interpolator for {@code @android:interpolator/trim_start_interpolator}. */
    static class TRIM_PATH_START {
        ...
        static final Interpolator INSTANCE = new PathInterpolator(PATH_TRIM_PATH_START);
