...
import  robertapengelly.support.animation.AnimatorSet;
...
class Animators {
     ...
     */
    static Animator createIndeterminate(Object target) {
        ...
        trimPathStartAnimator.setRepeatCount(ObjectAnimator.INFINITE);
        ...
        trimPathEndAnimator.setRepeatCount(ObjectAnimator.INFINITE);
        ...
        trimPathOffsetAnimator.setRepeatCount(ObjectAnimator.INFINITE);
     ...
     * @return An Animator object that is set up to behave the same as the its native counterpart.
     */
    static Animator createIndeterminateHorizontalRect1(Object target) {
     ...
     * @return An Animator object that is set up to behave the same as the its native counterpart.
     */
    static Animator createIndeterminateHorizontalRect2(Object target) {
     ...
     * @return An Animator object that is set up to behave the same as the its native counterpart.
     */
    static Animator createIndeterminateRotation(Object target) {
